<?php 
/*
Theme Name: sankita light theme
Theme URI: https://wordpress.org/themes/twentynineteen/
Author: michael Angelo Clemens
Author URI: https://www.yayasankitajuga.com/
...
<body>
 ...
 <header class="header-header" id="header-header">
  <nav class="navbar fixed-top navbar-expand-lg navbar-white bg-dark">
       <img src="http://www.yayasankitajuga.com/wp-content/uploads/2019/11/kj.png" width="40px" alt="logo yayasan kita juga"/><a class="text-white" href="http://www.yayasankitajuga.com/wp-content/uploads/2019/11/kj.png">Yayasan KitaJuga</a>
    ...
    <ul class="navbar-nav">
     ...
     <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item text-dark" href="http://www.yayasankitajuga.com/sejarah/">Sejarah</a>
          <a class="dropdown-item text-dark" href="http://www.yayasankitajuga.com/visi-dan-misi/">visi dan misi</a>
          <a class="dropdown-item text-dark" href="http://www.yayasankitajuga.com/pencapaian/">Pencapaian</a>
        </div>
      </li>
      <li>
        <a href=""></a>
